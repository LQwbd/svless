...
//let sub = '';// 留空则显示原版内容
let sub = 'w2.qingdeng.dns-dynamic.net';// 内置优选订阅生成器，可自行搭建 https://github.com/LQwbd/WorkerVless2sub
let subconverter = 'subapi-loadbalancing.pages.dev';// clash订阅转换后端，目前使用肥羊的订阅转换功能。自带虚假uuid和host订阅。
